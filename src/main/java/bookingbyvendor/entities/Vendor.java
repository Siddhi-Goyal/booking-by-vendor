package bookingbyvendor.entities;
...
public class Vendor {
    ...
    //Args Constructor
    public Vendor(int id, int vendor_num, String vendor_name, String created_timestamp, String created_by, String last_modified_timestamp, String last_modified_by, String manufacturing_vendor_party_id) {
        this.id = id;
